...
import 'package:t_transformcontroller0709/const_speed.dart';
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    switch (_gestureType!) {
      ...
      case _GestureType.pan:
        ...
        _transformationController!.value = _matrixTranslate(
          _transformationController!.value,
          Offset(translationChange.dx*panSpeedRatio, translationChange.dy*panSpeedRatio),
        );
        _referenceFocalPoint = _transformationController!.toScene(
          details.localFocalPoint,
        );
...
double _getFinalTime(double velocity, double drag) {
  ...
  return 0;
  // return math.log(effectivelyMotionless / velocity) / math.log(drag / 100) / 10000;
}
